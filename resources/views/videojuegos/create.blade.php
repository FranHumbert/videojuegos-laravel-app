                    ...
                    <form method="POST" action="{{ route('videojuegos.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('genero') is-invalid @enderror" 
                                   id="genero" name="genero" value="{{ old('genero') }}" required>
                            @error('genero')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('año_lanzamiento') is-invalid @enderror" 
                                   id="año_lanzamiento" name="año_lanzamiento" value="{{ old('año_lanzamiento') }}" required>
                        ...
                        <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ in_array($plataforma->id, old('plataformas', [])) ? 'checked' : '' }}>
                            ...
                            @else
                                <div class="alert alert-warning">
                                    ...
                                    <a href="{{ route('plataformas.create') }}">Crear una plataforma primero</a>.
                                </div>
                            @endif
                            @error('plataformas')
